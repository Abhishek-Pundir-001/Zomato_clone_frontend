...
function Footer() {
    return (
        <div className="footer-container flex flex-col items-center gap-5 text-[#d9d9d9] bg-[#323232] px-[8vw] py-5 pt-20">
            <div className="footer-sub-container flex justify-between">
                ...
                <div className="footer-center flex flex-col gap-3 items-start">
                    <h2 className="font-bold text-xl font-serif">COMPANY</h2>
                ...
                <div className="footer-right flex flex-col gap-3 items-start">
                    <h2 className="font-bold text-xl font-serif">GET IN TOUCH</h2>
                    <ul className="flex flex-col gap-2">
            ...
            <hr />
            <p className="footer-copyright font-serif">Copyright 2024 &copy; Tomato.com ~ All rights are reserved</p>
        </div>
    )
}
